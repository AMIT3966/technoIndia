...
class DepartmentRepository implements DepartmentInterface
{
    ...
    {        
        return StudentClass::latest()->get();
    }

    public function listAllDailySchedules()  // collet all data from dail_schedule table
    {        
        return DailySchedule::latest()->where('deleted_at',1)->get();
    }
}
